...
namespace Capstone.Web.Models
{
    public class SurveyResultModel
    {
        ...
        public static IEnumerable<SelectListItem> ActivityLevels = new List<SelectListItem>()
        {
        ...
        //public static IEnumerable<SelectListItem> ParksList(List<ParkDataModel> parks)
        //{
        //    List<SelectListItem> parks = new List<SelectListItem>();

        //    var allParkDetails = parkDAL.GetAllParks();
        //    foreach (var park in allParkDetails)
        //    {
